...
class FixGenerator:
    ...
    def create_prompt(self, issue):
        ...
        """
        return f"""
        You are a coding assistant. Analyze the following SonarQube issue and resolve it by generating a Git patch.
        The solution should eliminate the issue described in the issue while maintaining functionality and adhering to best practices.
        ...
        The response should be a JSON with 2 fields. First, a valid Git patch containing the fix. Second, a concise 3-4 line Pull Request (PR)
        description summarizing the changes and their purpose.
        ## Example
        {{ "fix": {{ "patch": <Replace with Git Patch>, "summary": <Replace with Description>}}}}
        """
